...
function loadTrack(track_index){
    ...
    if (music_list[track_index].name.length > maxCharsPerSong) {
        track_name.textContent = music_list[track_index].name.substring(0, maxCharsPerSong) + "..."; 
    } 
    else {
        track_name.textContent = music_list[track_index].name.substring(0, maxCharsPerSong);
    }
